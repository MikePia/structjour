...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.strategyUrls = QtWidgets.QComboBox(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.strategyUrls.sizePolicy().hasHeightForWidth())
        self.strategyUrls.setSizePolicy(sizePolicy)
        self.strategyUrls.setMinimumSize(QtCore.QSize(300, 0))
        self.strategyUrls.setObjectName("strategyUrls")
        self.horizontalLayout_3.addWidget(self.strategyUrls)
        self.strategyAdd_2 = QtWidgets.QLineEdit(self.layoutWidget)
        self.strategyAdd_2.setMinimumSize(QtCore.QSize(300, 0))
        self.strategyAdd_2.setObjectName("strategyAdd_2")
        self.horizontalLayout_3.addWidget(self.strategyAdd_2)
        self.strategyAddBtn_2 = QtWidgets.QPushButton(self.layoutWidget)
        self.strategyAddBtn_2.setObjectName("strategyAddBtn_2")
        self.horizontalLayout_3.addWidget(self.strategyAddBtn_2)
    ...
    def retranslateUi(self, Form):
        ...
        self.strategyAddBtn_2.setText(_translate("Form", "Add link"))
