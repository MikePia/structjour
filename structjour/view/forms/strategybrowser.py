...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.strategyCb = QtWidgets.QComboBox(Form)
        ...
        self.pageSelect = QtWidgets.QListWidget(Form)
        ...
        self.strategyAddLbl = QtWidgets.QLabel(Form)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.strategyAdd = QtWidgets.QLineEdit(Form)
        ...
        self.preferred = QtWidgets.QRadioButton(Form)
        self.preferred.setObjectName("preferred")
        self.verticalLayout.addWidget(self.preferred)
        self.notPreferred = QtWidgets.QRadioButton(Form)
