...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.wtdCb.setToolTip(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:9pt;\">To use Alphavantage APIs get a free API key from </span><a href=\"https://www.alphavantage.co/support/#api-key\"><span style=\" font-size:9pt; text-decoration: underline; color:#0000ff;\">https://www.alphavantage.co/support/#api-key </span></a><span style=\" font-size:9pt;\">   The data is realtime Historical data is available for the last 7 days. Data limts are 500 calls per day and 5 per minute.</span></p></body></html>"))
        self.wtdCb.setText(_translate("Dialog", "WorldTradeData"))
        self.label_11.setText(_translate("Dialog", "API Key"))
        self.label_9.setText(_translate("Dialog", "<html><head/><body><p><a href=\"https://www.alphavantage.co/terms_of_service/\"><span style=\" text-decoration: underline; color:#0000ff;\"> IEX has moved--disabled for now.</span></a></p></body></html>"))
        self.iexCb.setToolTip(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:12pt; color:#aa0914;\">IEX is no longer providing their API. They have outsourced to iexCloud. Looking into it. (9/12/19)</span></p></body></html>"))
